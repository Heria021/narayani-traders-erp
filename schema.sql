...
-- Atomically records a stock movement and updates current_stock when track_inventory = true.
-- Skips both writes for non-tracked products (no movement row, no stock change).
